...
namespace GXPEngine
{
    ...
    public struct Vec2
    {
        ...
        {
            return new Vec2(GetUnitVectorRad(Deg2Rad(degrees)));
        }
        ...
        public Vec2 Normal()
        {
            ...
            //return new Vec2( (y * -1) / Length(), x / Length());;
            return new Vec2(vec.y * -1, vec.x);
        }
        ...
        public void Reflect(float bounce, Vec2 normal)
        {
            Vec2 resultVec = this - (1 + bounce) * (Dot(normal)) * normal;
            this = resultVec;
        }
